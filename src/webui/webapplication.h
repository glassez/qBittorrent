...
private:
    ...
    void sendResponse(Http::ResponseWriter &responseWriter, quint16 statusCode, const QString &statusText = {}
            , const Http::HeaderMap &headers = {}, const QByteArray &content = {});
    void sendFile(Http::ResponseWriter *responseWriter, const Path &path);
    void sendWebUIFile(Http::ResponseWriter *responseWriter);
    Http::Response processAPIRequest(const QString &endpoint);
