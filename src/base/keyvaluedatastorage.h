...
// There are 2 ways for class `T` provide serialization support into `KeyValueDataStorage`:
...
class KeyValueDataStorage : public QObject
{
    Q_OBJECT
...
protected:
    virtual QVariant loadValueImpl(const QString &key, const QVariant &defaultValue = {}) const = 0;
    virtual void storeValueImpl(const QString &key, const QVariant &value) = 0;
};
