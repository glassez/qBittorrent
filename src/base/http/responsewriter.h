...
namespace Http
{
    ...
    public:
        ResponseWriter(QAbstractSocket &socket, const Request &request, QObject *parent = nullptr);

        // Send entire response at once.
        // Allow response content to be gzip encoded.
        void setResponse(quint16 statusCode, const QString &statusText, const HeaderMap &headers, const QByteArray &content);
        ...
        void beginResponse(quint16 statusCode, const QString &statusText, const HeaderMap &headers, qsizetype contentSize);
