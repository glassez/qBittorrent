...
namespace BitTorrent
{
    ...
    public:
        ...
        std::variant<QString, Path> storedTorrentInfo() const;
        void setStoredTorrentInfo(const std::variant<QString, Path> &info);
    ...
    private:
        ...
        std::variant<QString, Path> m_storedTorrentInfo;
